...
CREATE TABLE `appeal` (
  ...
  PRIMARY KEY (`id`),
  KEY `user` (`user`),
  CONSTRAINT `appeal_ibfk_1` FOREIGN KEY (`user`) REFERENCES `user` (`id`)
...
INSERT INTO `role` VALUES (1,'admin','Has full access to system'),(2,'specialist','Work with status'),(3,'user','Can make an appeal');
...
INSERT INTO `status` VALUES (1,'New'),(2,'In process'),(3,'Error'),(4,'Rejected'),(5,'Solved');
...
INSERT INTO `test` VALUES (1,'admin','adminpass'),(14,'a','a'),(15,'s','s');
...
INSERT INTO `type` VALUES (1,'Computer problem'),(2,'Internet connection'),(3,'Resource Access'),(4,'Granting access'),(5,'Other');
...
INSERT INTO `user` VALUES (1,'nubug','test','Shades of Cool',1);
...
-- Dump completed on 2020-01-25 13:58:32
